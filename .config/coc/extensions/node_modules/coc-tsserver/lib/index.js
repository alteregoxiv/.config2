...
var require_disposable = __commonJS((exports2) => {
  ...
  })(Disposable14 = exports2.Disposable || (exports2.Disposable = {}));
});
...
var require_cancellation = __commonJS((exports2) => {
  ...
  var CancellationToken21;
  (function(CancellationToken22) {
    CancellationToken22.None = Object.freeze({
      isCancellationRequested: false,
      onCancellationRequested: events_1.Event.None
    });
    CancellationToken22.Cancelled = Object.freeze({
      isCancellationRequested: true,
      onCancellationRequested: events_1.Event.None
    });
    function is2(value) {
      const candidate = value;
      return candidate && (candidate === CancellationToken22.None || candidate === CancellationToken22.Cancelled || Is.boolean(candidate.isCancellationRequested) && !!candidate.onCancellationRequested);
    }
    CancellationToken22.is = is2;
  })(CancellationToken21 = exports2.CancellationToken || (exports2.CancellationToken = {}));
  ...
  var CancellationTokenSource4 = class {
    ...
    cancel() {
      if (!this._token) {
        this._token = CancellationToken21.Cancelled;
      } else {
        this._token.cancel();
      }
    }
    dispose() {
      if (!this._token) {
        this._token = CancellationToken21.None;
...
var require_main2 = __commonJS((exports2) => {
  ...
  (function(Location5) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range18.is(candidate.range) && (Is.string(candidate.uri) || Is.undefined(candidate.uri));
    }
    Location5.is = is2;
  })(Location4 || (Location4 = {}));
  var LocationLink;
  (function(LocationLink2) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range18.is(candidate.targetRange) && Is.string(candidate.targetUri) && (Range18.is(candidate.targetSelectionRange) || Is.undefined(candidate.targetSelectionRange)) && (Range18.is(candidate.originSelectionRange) || Is.undefined(candidate.originSelectionRange));
    }
  ...
  (function(ColorInformation2) {
    ...
    function is2(value) {
      var candidate = value;
      return Range18.is(candidate.range) && Color.is(candidate.color);
    }
  ...
  (function(TextEdit7) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.objectLiteral(candidate) && Is.string(candidate.newText) && Range18.is(candidate.range);
    }
    TextEdit7.is = is2;
  })(TextEdit6 || (TextEdit6 = {}));
  ...
  (function(InsertReplaceEdit2) {
    ...
    function is2(value) {
      var candidate = value;
      return candidate && Is.string(candidate.newText) && Range18.is(candidate.insert) && Range18.is(candidate.replace);
    }
  ...
  (function(Hover2) {
    function is2(value) {
      var candidate = value;
      return !!candidate && Is.objectLiteral(candidate) && (MarkupContent3.is(candidate.contents) || MarkedString.is(candidate.contents) || Is.typedArray(candidate.contents, MarkedString.is)) && (value.range === void 0 || Range18.is(value.range));
    }
    Hover2.is = is2;
  })(Hover || (Hover = {}));
  ...
  (function(DocumentSymbol3) {
    ...
    function is2(value) {
      var candidate = value;
      return candidate && Is.string(candidate.name) && Is.number(candidate.kind) && Range18.is(candidate.range) && Range18.is(candidate.selectionRange) && (candidate.detail === void 0 || Is.string(candidate.detail)) && (candidate.deprecated === void 0 || Is.boolean(candidate.deprecated)) && (candidate.children === void 0 || Array.isArray(candidate.children)) && (candidate.tags === void 0 || Array.isArray(candidate.tags));
    }
  ...
  (function(CodeLens3) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range18.is(candidate.range) && (Is.undefined(candidate.command) || Command5.is(candidate.command));
    }
    CodeLens3.is = is2;
  })(CodeLens2 || (CodeLens2 = {}));
  ...
  (function(DocumentLink2) {
    ...
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Range18.is(candidate.range) && (Is.undefined(candidate.target) || Is.string(candidate.target));
    }
  ...
  (function(SelectionRange2) {
    ...
    function is2(value) {
      var candidate = value;
      return candidate !== void 0 && Range18.is(candidate.range) && (candidate.parent === void 0 || SelectionRange2.is(candidate.parent));
    }
    SelectionRange2.is = is2;
  })(SelectionRange || (SelectionRange = {}));
  var EOL = ["\n", "\r\n", "\r"];
  var TextDocument14;
  (function(TextDocument15) {
    function create(uri, languageId, version, content) {
      return new FullTextDocument(uri, languageId, version, content);
    }
    TextDocument15.create = create;
    function is2(value) {
      var candidate = value;
      return Is.defined(candidate) && Is.string(candidate.uri) && (Is.undefined(candidate.languageId) || Is.string(candidate.languageId)) && Is.uinteger(candidate.lineCount) && Is.func(candidate.getText) && Is.func(candidate.positionAt) && Is.func(candidate.offsetAt) ? true : false;
    }
    TextDocument15.is = is2;
    ...
    TextDocument15.applyEdits = applyEdits;
...
var require_range = __commonJS((exports2, module2) => {
  var Range18 = class {
    constructor(range, options) {
      ...
      if (range instanceof Range18) {
        if (range.loose === !!options.loose && range.includePrerelease === !!options.includePrerelease) {
          return range;
        } else {
          return new Range18(range.raw, options);
        }
      }
  ...
  var Comparator = class {
    ...
    intersects(comp, options) {
      ...
      if (this.operator === "") {
        ...
        return new Range18(comp.value, options).test(this.value);
      } else if (comp.operator === "") {
        if (comp.value === "") {
          return true;
        }
        return new Range18(this.value, options).test(comp.semver);
      }
...
var require_satisfies = __commonJS((exports2, module2) => {
  ...
  var satisfies = (version, range, options) => {
    try {
      range = new Range18(range, options);
    } catch (er) {
      return false;
    }
...
var require_to_comparators = __commonJS((exports2, module2) => {
  var Range18 = require_range();
  var toComparators = (range, options) => new Range18(range, options).set.map((comp) => comp.map((c) => c.value).join(" ").trim().split(" "));
...
var require_max_satisfying = __commonJS((exports2, module2) => {
  ...
  var maxSatisfying = (versions, range, options) => {
    ...
    let rangeObj = null;
    try {
      rangeObj = new Range18(range, options);
    } catch (er) {
      return null;
    }
    versions.forEach((v) => {
...
var require_valid2 = __commonJS((exports2, module2) => {
  ...
  var validRange = (range, options) => {
    try {
      return new Range18(range, options).range || "*";
    } catch (er) {
      return null;
    }
  };
...
var require_intersects = __commonJS((exports2, module2) => {
  ...
  var intersects = (r1, r2, options) => {
    r1 = new Range18(r1, options);
    r2 = new Range18(r2, options);
...
var require_subset = __commonJS((exports2, module2) => {
  ...
  var subset = (sub, dom, options) => {
    sub = new Range18(sub, options);
    dom = new Range18(dom, options);
...
var import_coc39 = __toModule(require("coc.nvim"));
...
API.v370 = API2.fromSimpleString("3.7.0");
...
(function(Range18) {
  ...
  Range18.fromLocations = (start, end) => language.Range.create(Math.max(0, start.line - 1), Math.max(start.offset - 1, 0), Math.max(0, end.line - 1), Math.max(0, end.offset - 1));
  Range18.toFormattingRequestArgs = (file2, range) => ({
    file: file2,
  ...
  Range18.toFileRangeRequestArgs = (file2, range) => ({
    file: file2,
...
var TypeScriptDocumentSemanticTokensProvider = class {
  ...
  async _provideSemanticTokens(document, requestArg, token) {
    ...
    const builder = new import_coc20.SemanticTokensBuilder();
    let i = 0;
...
TypeScriptDocumentSemanticTokensProvider.minVersion = api_default.v370;
var semanticTokens_default = TypeScriptDocumentSemanticTokensProvider;
...
(function(TokenType2) {
  ...
  TokenType2[TokenType2["method"] = 11] = "method";
  TokenType2[TokenType2["_"] = 12] = "_";
})(TokenType || (TokenType = {}));
var TokenModifier;
(function(TokenModifier2) {
  ...
  TokenModifier2[TokenModifier2["_"] = 6] = "_";
})(TokenModifier || (TokenModifier = {}));
var TokenEncodingConsts;
(function(TokenEncodingConsts2) {
...
(function(ExperimentalProtocol2) {
  let EndOfLineState;
  (function(EndOfLineState2) {
...
var tokenTypeMap = [];
tokenTypeMap[ExperimentalProtocol.ClassificationType.className] = 0;
tokenTypeMap[ExperimentalProtocol.ClassificationType.enumName] = 1;
tokenTypeMap[ExperimentalProtocol.ClassificationType.interfaceName] = 2;
tokenTypeMap[ExperimentalProtocol.ClassificationType.moduleName] = 3;
tokenTypeMap[ExperimentalProtocol.ClassificationType.typeParameterName] = 4;
tokenTypeMap[ExperimentalProtocol.ClassificationType.typeAliasName] = 5;
tokenTypeMap[ExperimentalProtocol.ClassificationType.parameterName] = 6;
...
var TagClosing2 = class {
  constructor(client, descriptionLanguageId) {
    ...
    this._cancel = void 0;
    import_coc21.events.on("InsertCharPre", (character) => {
      this.lastInsert = character;
    }, null, this._disposables);
    import_coc21.events.on("TextChangedI", this.onChange, this, this._disposables);
    import_coc21.events.on("TextChangedP", this.onChange, this, this._disposables);
  }
  async onChange(bufnr, change) {
    let doc = import_coc21.workspace.getDocument(bufnr);
    if (!doc || !doc.attached)
      return;
    ...
    this._timeout = setTimeout(async () => {
      ...
      if (doc.changedtick > changedtick)
        return;
      const position = import_coc21.Position.create(lnum - 1, pre.length);
      const args = Position.toFileLocationRequestArgs(filepath, position);
      this._cancel = new import_coc21.CancellationTokenSource();
      ...
      if (doc.changedtick === changedtick) {
        import_coc21.snippetManager.insertSnippet(this.getTagSnippet(insertion).value, false, import_coc21.Range.create(position, position));
      }
    }, 50);
  }
  isEnabled(languageId, uri) {
    ...
    if (!import_coc21.workspace.getConfiguration(void 0, uri).get(`${configLang}.autoClosingTags`)) {
      return false;
    }
    return true;
  }
  dispose() {
    ...
    import_coc21.disposeAll(this._disposables);
    this._disposables = [];
  }
...
var UpdateImportsOnFileRenameHandler = class {
  constructor(client, fileConfigurationManager, languageId) {
    ...
    const watcher = import_coc22.workspace.createFileSystemWatcher(glob);
  ...
  dispose() {
    import_coc22.disposeAll(this.disposables);
  }
  async doRename(oldResource, newResource) {
    ...
    let oldDocument = import_coc22.workspace.getDocument(oldResource.toString());
    if (oldDocument) {
      await import_coc22.workspace.nvim.command(`silent ${oldDocument.bufnr}bwipeout!`);
    }
    let document = import_coc22.workspace.getDocument(newUri);
    if (document) {
      await import_coc22.workspace.nvim.command(`silent ${document.bufnr}bwipeout!`);
      await wait(30);
    }
    document = await import_coc22.workspace.loadFile(newUri);
    if (!document)
      return;
    await wait(50);
    ...
    if (await this.promptUser(newResource)) {
      await import_coc22.workspace.applyEdit(edits);
    }
  }
  async promptUser(newResource) {
    return await import_coc22.window.showPrompt(`Update imports for moved file: ${newResource.fsPath}?`);
  }
...
var OrganizeImportsCommand = class {
  ...
  async _execute(client, document, sortOnly = false) {
    ...
    if (keys.length == 1) {
      let doc = import_coc23.workspace.getDocument(keys[0]);
      if (doc) {
  ...
  async execute(document, sortOnly = false) {
    let client = await this.service.getClientHost();
    if (!document) {
      let doc = await import_coc23.workspace.document;
      if (!doc.attached) {
...
var OrganizeImportsCodeActionProvider = class {
  ...
  async provideCodeActions(document, _range, context, token) {
    ...
    const organizeImportsAction = import_vscode_languageserver_protocol17.CodeAction.create("Organize Imports", {
      title: "",
      command: "tsserver.organizeImports",
      arguments: [document]
    }, import_vscode_languageserver_protocol17.CodeActionKind.SourceOrganizeImports);
    const sortImportsAction = import_vscode_languageserver_protocol17.CodeAction.create("Sort Imports", {
      title: "",
...
var LanguageProvider = class {
  constructor(client, fileConfigurationManager, description, typingsStatus) {
    ...
    this.disposables = [];
    import_coc24.workspace.onDidChangeConfiguration(this.configurationChanged, this, this.disposables);
  ...
  configurationChanged() {
    const config = import_coc24.workspace.getConfiguration(this.id, null);
    this.client.diagnosticsManager.setEnableSuggestions(this.id, config.get(suggestionSetting, true));
  }
  dispose() {
    import_coc24.disposeAll(this.disposables);
  }
  ...
  registerProviders(client, typingsStatus) {
    ...
    this._register(import_coc24.languages.registerCompletionItemProvider(clientId, "TSC", languageIds, new completionItemProvider_default(client, typingsStatus, this.fileConfigurationManager, this.description.id), completionItemProvider_default.triggerCharacters));
    if (this.client.apiVersion.gte(api_default.v230)) {
      this._register(import_coc24.languages.registerCompletionItemProvider(`${this.description.id}-directive`, "TSC", languageIds, new directiveCommentCompletions_default(client), ["@"]));
    }
    let definitionProvider = new definitionProvider_default(client);
    this._register(import_coc24.languages.registerDefinitionProvider(languageIds, definitionProvider));
    this._register(import_coc24.languages.registerTypeDefinitionProvider(languageIds, definitionProvider));
    this._register(import_coc24.languages.registerImplementationProvider(languageIds, definitionProvider));
    this._register(import_coc24.languages.registerReferencesProvider(languageIds, new references_default(client)));
    this._register(import_coc24.languages.registerHoverProvider(languageIds, new hover_default(client)));
    this._register(import_coc24.languages.registerDocumentHighlightProvider(languageIds, new documentHighlight_default(this.client)));
    this._register(import_coc24.languages.registerSignatureHelpProvider(languageIds, new signatureHelp_default(client), ["(", ",", "<", ")"]));
    this._register(import_coc24.languages.registerDocumentSymbolProvider(languageIds, new documentSymbol_default(client)));
    this._register(import_coc24.languages.registerRenameProvider(languageIds, new rename_default(client, this.fileConfigurationManager)));
    let formatProvider = new formatting_default(client, this.fileConfigurationManager);
    this._register(import_coc24.languages.registerDocumentFormatProvider(languageIds, formatProvider));
    this._register(import_coc24.languages.registerDocumentRangeFormatProvider(languageIds, formatProvider));
    this._register(import_coc24.languages.registerOnTypeFormattingEditProvider(languageIds, formatProvider, [";", "}", "\n", String.fromCharCode(27)]));
    this._register(import_coc24.languages.registerCodeActionProvider(languageIds, new moduleInstall_default(client), "tsserver"));
    if (this.client.apiVersion.gte(api_default.v380) && typeof import_coc24.languages["registerCallHierarchyProvider"] === "function") {
      this._register(import_coc24.languages.registerCallHierarchyProvider(languageIds, new callHierarchy_default(client)));
    }
    if (this.client.apiVersion.gte(api_default.v370)) {
      const provider = new semanticTokens_default(client);
      if (typeof import_coc24.languages["registerDocumentSemanticTokensProvider"] === "function") {
        this._register(import_coc24.languages.registerDocumentSemanticTokensProvider(languageIds, provider, provider.getLegend()));
      }
      if (typeof import_coc24.languages["registerDocumentRangeSemanticTokensProvider"] === "function") {
        this._register(import_coc24.languages.registerDocumentRangeSemanticTokensProvider(languageIds, provider, provider.getLegend()));
      }
    }
    ...
    if (this.client.apiVersion.gte(api_default.v280)) {
      this._register(import_coc24.languages.registerFoldingRangeProvider(languageIds, new folding_default(this.client)));
      this._register(import_coc24.languages.registerCodeActionProvider(languageIds, new OrganizeImportsCodeActionProvider(this.client, this.fileConfigurationManager), "tsserver", [import_vscode_languageserver_protocol18.CodeActionKind.SourceOrganizeImports]));
    }
    if (this.client.apiVersion.gte(api_default.v240)) {
      this._register(import_coc24.languages.registerCodeActionProvider(languageIds, new refactor_default(client, this.fileConfigurationManager), "tsserver", [import_vscode_languageserver_protocol18.CodeActionKind.Refactor]));
    }
    this._register(import_coc24.languages.registerCodeActionProvider(languageIds, new quickfix_default(client, this.fileConfigurationManager), "tsserver", [import_vscode_languageserver_protocol18.CodeActionKind.QuickFix]));
    this._register(import_coc24.languages.registerCodeActionProvider(languageIds, new importFix_default(this.client.bufferSyncSupport), "tsserver", [import_vscode_languageserver_protocol18.CodeActionKind.QuickFix]));
    ...
    if (this.client.apiVersion.gte(api_default.v206) && conf.get("referencesCodeLens.enable")) {
      this._register(import_coc24.languages.registerCodeLensProvider(languageIds, new referencesCodeLens_default(client, cachedResponse)));
    }
    if (this.client.apiVersion.gte(api_default.v220) && conf.get("implementationsCodeLens.enable")) {
      this._register(import_coc24.languages.registerCodeLensProvider(languageIds, new implementationsCodeLens_default(client, cachedResponse)));
    }
    if (this.client.apiVersion.gte(api_default.v350)) {
      this._register(import_coc24.languages.registerSelectionRangeProvider(languageIds, new smartSelect_default(this.client)));
    }
    if (this.client.apiVersion.gte(api_default.v300)) {
  ...
  handles(resource, doc) {
    ...
    const base = import_path5.default.basename(import_coc24.Uri.parse(resource).fsPath);
  ...
  diagnosticsReceived(diagnosticsKind, file2, diagnostics) {
    const config = import_coc24.workspace.getConfiguration(this.id, file2.toString());
...
function defaultPathNormalizer(resource) {
  let u = import_coc25.Uri.parse(resource);
  if (u.scheme === "file") {
    return u.fsPath;
  }
...
var SyncedBufferMap = class extends ResourceMap {
  getForPath(filePath) {
    return this.get(import_coc26.Uri.file(filePath).toString());
  }
  get allBuffers() {
    return this.values;
  }
...
var BufferSyncSupport = class {
  constructor(client, modeIds) {
    ...
    import_coc26.workspace.onDidChangeConfiguration(this.updateConfiguration, this, this.disposables);
  }
  listen() {
    if (this.listening)
      return;
    this.listening = true;
    import_coc26.workspace.onDidOpenTextDocument(this.openTextDocument, this, this.disposables);
    import_coc26.workspace.onDidCloseTextDocument(this.onDidCloseTextDocument, this, this.disposables);
    import_coc26.workspace.onDidChangeTextDocument(this.onDidChangeTextDocument, this, this.disposables);
    import_coc26.workspace.textDocuments.forEach(this.openTextDocument, this);
  }
  handles(resource) {
  ...
  dispose() {
    ...
    import_coc26.disposeAll(this.disposables);
  ...
  ensureHasBuffer(resource) {
    ...
    const existingDocument = import_coc26.workspace.textDocuments.find((doc) => doc.uri.toString() === resource);
    if (existingDocument) {
  ...
  toResource(filePath) {
    ...
    return import_coc26.Uri.file(filePath).toString();
  }
  reset() {
    var _a;
  ...
  openTextDocument(document) {
    ...
    const filepath = this.client.normalizePath(import_coc26.Uri.parse(resource));
    if (!filepath) {
      return false;
    }
    if (this.syncedBuffers.has(resource)) {
  ...
  sendPendingDiagnostics() {
    ...
    if (orderedFileSet.size) {
      let uris = Array.from(orderedFileSet.uris).map((uri) => import_coc26.Uri.parse(uri));
  ...
  updateConfiguration() {
    const jsConfig = import_coc26.workspace.getConfiguration("javascript", null);
    const tsConfig = import_coc26.workspace.getConfiguration("typescript", null);
...
var DiagnosticsManager = class {
  constructor() {
    ...
    this._currentDiagnostics = import_coc27.languages.createDiagnosticCollection("tsserver");
  }
  dispose() {
  ...
  diagnosticsReceived(kind, uri, diagnostics) {
    ...
    if (!collection)
      return;
    let doc = import_coc27.workspace.getDocument(uri);
    if (doc)
      uri = doc.uri;
    if (diagnostics.length === 0) {
...
var TypeScriptServiceConfiguration = class {
  constructor() {
    this._configuration = import_coc28.workspace.getConfiguration("tsserver");
    this._includePackageJsonAutoImports = import_coc28.workspace.getConfiguration("typescript").get("preferences.includePackageJsonAutoImports");
    import_coc28.workspace.onDidChangeConfiguration(() => {
      this._configuration = import_coc28.workspace.getConfiguration("tsserver");
      this._includePackageJsonAutoImports = import_coc28.workspace.getConfiguration("typescript").get("preferences.includePackageJsonAutoImports");
    });
  }
  ...
  get npmLocation() {
    ...
    if (path9)
      return import_coc28.workspace.expand(path9);
    try {
...
var Logger = class {
  get output() {
    ...
    this._channel = import_coc29.window.createOutputChannel("tsserver");
    return this._channel;
  }
  dispose() {
    if (this._channel) {
...
var Tracer = class {
  ...
  static readTrace() {
    let result = Trace.fromString(import_coc30.workspace.getConfiguration("tsserver").get("trace.server", "off"));
...
var TypeScriptVersionProvider = class {
  ...
  get globalVersion() {
    let {globalTsdk} = this.configuration;
    if (globalTsdk)
      return new TypeScriptVersion(import_coc31.workspace.expand(globalTsdk));
    return void 0;
  }
  getLocalVersion() {
    let folders = import_coc31.workspace.workspaceFolders.map((f) => import_coc31.Uri.parse(f.uri).fsPath);
  ...
  get bundledVersion() {
    try {
      ...
      import_coc31.window.showMessage("Bundled typescript module not found", "error");
      return null;
    }
  }
};
...
var VersionStatus = class {
  constructor(_normalizePath, enableJavascript) {
    ...
    this._versionString = "";
    this._versionBarEntry = import_coc32.window.createStatusBarItem(99);
    this._onChangeEditorSub = import_coc32.events.on("BufEnter", this.onBufEnter, this);
  ...
  async onBufEnter(bufnr) {
    let filetype = await import_coc32.workspace.nvim.call("getbufvar", [bufnr, "&filetype", ""]);
...
var Reader = class {
  constructor(readable) {
    ...
    this.nextMessageLength = -1;
    this.disposables = [];
    this._onError = new import_vscode_languageserver_protocol21.Emitter();
    this.onError = this._onError.event;
    this._onData = new import_vscode_languageserver_protocol21.Emitter();
  ...
  dispose() {
    import_coc33.disposeAll(this.disposables);
  }
};
...
var tsServerProcess_default = ForkedTsServerProcess;
...
var TypeScriptServiceClient = class {
  constructor(pluginManager, modeIds) {
    ...
    this.token = 0;
    this.state = import_coc34.ServiceStat.Initial;
    ...
    this._onTsServerStarted = new import_vscode_languageserver_protocol22.Emitter();
    this._onProjectLanguageServiceStateChanged = new import_vscode_languageserver_protocol22.Emitter();
    this._onDidBeginInstallTypings = new import_vscode_languageserver_protocol22.Emitter();
    this._onDidEndInstallTypings = new import_vscode_languageserver_protocol22.Emitter();
    this._onTypesInstallerInitializationFailed = new import_vscode_languageserver_protocol22.Emitter();
    this.disposables = [];
    this.isRestarting = false;
    this._onDiagnosticsReceived = new import_vscode_languageserver_protocol22.Emitter();
    this._onConfigDiagnosticsReceived = new import_vscode_languageserver_protocol22.Emitter();
    this._onResendModelsRequested = new import_vscode_languageserver_protocol22.Emitter();
  ...
  restartTsServer() {
    if (this.tsServerProcess) {
      this.state = import_coc34.ServiceStat.Stopping;
  ...
  stop() {
    return new Promise((resolve) => {
      ...
      if (tsServerProcess && this.state == import_coc34.ServiceStat.Running) {
        this.info("Killing TS Server");
  ...
  startService(resendModels = false) {
    ...
    if (!currentVersion || !currentVersion.isValid) {
      if (this.configuration.globalTsdk) {
        import_coc34.window.showErrorMessage(`Can not find typescript module, in 'tsserver.tsdk': ${this.configuration.globalTsdk}`);
      } else {
        import_coc34.window.showErrorMessage(`Can not find typescript module, run ':CocInstall coc-tsserver' to fix it!`);
      }
      return;
    }
  ...
  startProcess(currentVersion, args, options, resendModels) {
    ...
    this.state = import_coc34.ServiceStat.Starting;
    try {
      let childProcess = fork(currentVersion.tsServerPath, args, options, this.logger);
      this.state = import_coc34.ServiceStat.Running;
      this.info("Starting TSServer", JSON.stringify(currentVersion, null, 2));
      const handle = new tsServerProcess_default(childProcess);
      this.tsServerProcess = handle;
      this.lastStart = Date.now();
      handle.onError((err) => {
        if (this.token != myToken)
          return;
        import_coc34.window.showErrorMessage(`TypeScript language server exited with error. Error message is: ${err.message}`);
        this.error("TSServer errored with error.", err);
        this.error(`TSServer log file: ${this.tsServerLogFile || ""}`);
        import_coc34.window.showMessage(`TSServer errored with error. ${err.message}`, "error");
      ...
      this.state = import_coc34.ServiceStat.StartFailed;
  ...
  async openTsServerLogFile() {
    ...
    let echoErr = (msg) => {
      import_coc34.window.showErrorMessage(msg);
    };
    if (isRoot) {
    ...
    try {
      await import_coc34.workspace.nvim.command(`edit ${this.tsServerLogFile}`);
      return true;
    } catch {
  ...
  serviceExited(restart) {
    this.state = import_coc34.ServiceStat.Stopped;
    this.tsServerLogFile = null;
    ...
    if (restart) {
      ...
      if (this.numberRestarts > 5) {
        ...
        if (diff < 10 * 1e3) {
          this.lastStart = Date.now();
          startService = false;
          import_coc34.window.showMessage("The TypeScript language service died 5 times right after it got started.", "error");
        } else if (diff < 60 * 1e3) {
          this.lastStart = Date.now();
          import_coc34.window.showMessage("The TypeScript language service died unexpectedly 5 times in the last 5 Minutes.", "error");
        }
      }
      if (startService) {
        this.startService(true);
  ...
  toPath(uri) {
    return this.normalizePath(import_coc34.Uri.parse(uri));
  }
  ...
  toResource(filepath) {
    if (this._apiVersion.gte(api_default.v213)) {
      if (filepath.startsWith(this.inMemoryResourcePrefix + "untitled:")) {
        let resource = import_coc34.Uri.parse(filepath);
  ...
  getDocument(resource) {
    if (resource.startsWith("untitled:")) {
      ...
      return import_coc34.workspace.getDocument(bufnr);
    }
    return import_coc34.workspace.getDocument(resource);
  }
  ...
  asUrl(filepath) {
    if (this._apiVersion.gte(api_default.v213)) {
      if (filepath.startsWith(this.inMemoryResourcePrefix + "untitled:")) {
        let resource = import_coc34.Uri.parse(filepath.slice(this.inMemoryResourcePrefix.length));
        if (this.inMemoryResourcePrefix) {
          const dirName = import_path8.default.dirname(resource.path);
          const fileName = import_path8.default.basename(resource.path);
          if (fileName.startsWith(this.inMemoryResourcePrefix)) {
    ...
    return import_coc34.Uri.file(filepath);
  }
  execute(command, args, token, config) {
    var _a;
    let execution;
    if (config == null ? void 0 : config.cancelOnResourceChange) {
      const source = new import_vscode_languageserver_protocol22.CancellationTokenSource();
  ...
  fatalError(command, error) {
    ...
    if (this.state === import_coc34.ServiceStat.Running) {
  ...
  dispatchEvent(event) {
    switch (event.event) {
      ...
      case "projectsUpdatedInBackground":
        ...
        const resources = body.openFiles.map(import_coc34.Uri.file);
    ...
    if (this.apiVersion.gte(api_default.v230)) {
      ...
      pluginPaths = pluginPaths.reduce((p, c) => {
        if (import_path8.default.isAbsolute(c)) {
          ...
          let roots = import_coc34.workspace.workspaceFolders.map((o) => import_coc34.Uri.parse(o.uri).fsPath);
  ...
  getProjectRootPath(uri) {
    let root = import_coc34.workspace.cwd;
    let u = import_coc34.Uri.parse(uri);
    if (u.scheme !== "file")
      return void 0;
    let folder = import_coc34.workspace.getWorkspaceFolder(uri);
    if (folder) {
      root = import_coc34.Uri.parse(folder.uri).fsPath;
    } else {
      let filepath = import_coc34.Uri.parse(uri).fsPath;
  ...
  cancelInflightRequestsForResource(resource) {
    if (this.state !== import_coc34.ServiceStat.Running || !this.tsServerProcess) {
      return;
    }
...
var AtaProgressReporter = class {
  constructor(client) {
    ...
    this._invalid = false;
    this.statusItem = import_coc35.window.createStatusBarItem(10, {progress: true});
    const disposables = [];
    ...
    this._disposable = import_vscode_languageserver_protocol23.Disposable.create(() => {
  ...
  async onTypesInstallerInitializationFailed() {
    this.statusItem.hide();
    if (!this._invalid) {
      const config = import_coc35.workspace.getConfiguration("typescript");
      if (config.get("check.npmIsInstalled", true)) {
        const dontShowAgain = "Don't Show Again";
        const selected = await import_coc35.window.showWarningMessage("Could not install typings files for JavaScript language features. Please ensure that NPM is installed or configure 'typescript.npm' in your user settings. visit https://go.microsoft.com/fwlink/?linkid=847635  to learn more.", dontShowAgain);
...
var TypeScriptServiceClientHost = class {
  constructor(descriptions, pluginManager) {
    ...
    const configFileWatcher = import_coc36.workspace.createFileSystemWatcher("**/[tj]sconfig.json");
    ...
    const packageFileWatcher = import_coc36.workspace.createFileSystemWatcher("**/package.json");
    ...
    this.disposables.push(import_coc36.languages.registerWorkspaceSymbolProvider(new workspaceSymbols_default(this.client, allModeIds)));
    this.client.onConfigDiagnosticsReceived((diag) => {
      let {body} = diag;
      if (body) {
        let {configFile, diagnostics} = body;
        let uri = import_coc36.Uri.file(configFile);
        if (diagnostics.length == 0) {
          ...
          let diagnosticList = diagnostics.map((o) => {
            ...
            let range;
            if (!start || !end) {
              range = import_vscode_languageserver_protocol24.Range.create(import_vscode_languageserver_protocol24.Position.create(0, 0), import_vscode_languageserver_protocol24.Position.create(0, 1));
            } else {
              range = import_vscode_languageserver_protocol24.Range.create(start.line - 1, start.offset - 1, end.line - 1, end.offset - 1);
            }
            let severity = category == "error" ? import_vscode_languageserver_protocol24.DiagnosticSeverity.Error : import_vscode_languageserver_protocol24.DiagnosticSeverity.Warning;
            return import_vscode_languageserver_protocol24.Diagnostic.create(range, text, severity, code);
          });
    ...
    import_coc36.workspace.onDidChangeConfiguration(this.configurationChanged, this, this.disposables);
    this.configurationChanged();
  }
  ...
  dispose() {
    import_coc36.disposeAll(this.disposables);
  ...
  reloadProjects() {
    ...
    this.client.execute("reloadProjects", null, import_vscode_languageserver_protocol24.CancellationToken.None);
    this.triggerAllDiagnostics();
  }
  ...
  configurationChanged() {
    const config = import_coc36.workspace.getConfiguration("tsserver");
  ...
  tsDiagnosticToLspDiagnostic(diagnostic) {
    ...
    if (diagnostic.reportsUnnecessary) {
      tags.push(import_vscode_languageserver_protocol24.DiagnosticTag.Unnecessary);
    }
    if (diagnostic.reportsDeprecated) {
      tags.push(import_vscode_languageserver_protocol24.DiagnosticTag.Deprecated);
    }
  ...
  getDiagnosticSeverity(diagnostic) {
    if (this.reportStyleCheckAsWarnings && this.isStyleCheckDiagnostic(diagnostic.code) && diagnostic.category === DiagnosticCategory.error) {
      return import_vscode_languageserver_protocol24.DiagnosticSeverity.Warning;
    }
    switch (diagnostic.category) {
      case DiagnosticCategory.error:
        return import_vscode_languageserver_protocol24.DiagnosticSeverity.Error;
      case DiagnosticCategory.warning:
        return import_vscode_languageserver_protocol24.DiagnosticSeverity.Warning;
      case DiagnosticCategory.suggestion:
        return import_vscode_languageserver_protocol24.DiagnosticSeverity.Information;
      default:
        return import_vscode_languageserver_protocol24.DiagnosticSeverity.Error;
    }
  }
...
var TsserverService = class {
  constructor(pluginManager) {
    ...
    this._onDidServiceReady = new import_vscode_languageserver_protocol25.Emitter();
    this.onServiceReady = this._onDidServiceReady.event;
    this.disposables = [];
    this.descriptions = [];
    const config = import_coc37.workspace.getConfiguration("tsserver");
  ...
  get config() {
    return import_coc37.workspace.getConfiguration("tsserver");
  }
  getClientHost() {
  ...
  dispose() {
    import_coc37.disposeAll(this.disposables);
  }
  restart() {
    if (!this.clientHost)
      return;
...
var import_coc38 = __toModule(require("coc.nvim"));
var import_vscode_languageserver_protocol26 = __toModule(require_main3());
...
var PluginManager = class {
  constructor() {
    ...
    this._disposables = [];
    this._onDidUpdatePlugins = this._register(new import_vscode_languageserver_protocol26.Emitter());
    this.onDidChangePlugins = this._onDidUpdatePlugins.event;
    this._onDidUpdateConfig = this._register(new import_vscode_languageserver_protocol26.Emitter());
    ...
    import_coc38.extensions.onDidActiveExtension(loadPlugins, void 0, this._disposables);
    import_coc38.extensions.onDidUnloadExtension(loadPlugins, void 0, this._disposables);
  }
  dispose() {
    import_coc38.disposeAll(this._disposables);
  }
  get plugins() {
    if (!this._plugins) {
  ...
  readPlugins() {
    ...
    for (const extension of import_coc38.extensions.all) {
...
async function activate(context) {
  ...
  const config = import_coc39.workspace.getConfiguration().get("tsserver", {});
  if (!config.enable)
    return;
  ...
  registCommand2(new SourceImportsCommand(service));
  registCommand2({
    id: "tsserver.restart",
    execute: () => {
      service.restart();
  ...
  service.start().then(() => {
    subscriptions.push(import_coc39.services.regist(service));
  }, (e) => {
